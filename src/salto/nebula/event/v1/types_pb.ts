...
import type { Installation } from "@saltoapis/nebula-installation-v1";
import { file_salto_nebula_installation_v1_installation } from "@saltoapis/nebula-installation-v1";
 ...
 */
export type InstallationUnblocked = Message<"salto.nebula.event.v1.InstallationUnblocked"> & {
  /**
...
/**
 * Describes the message salto.nebula.event.v1.InstallationUnblocked.
 * Use `create(InstallationUnblockedSchema)` to create a new message.
 */
export const InstallationUnblockedSchema: GenMessage<InstallationUnblocked> = /*@__PURE__*/
  messageDesc(file_salto_nebula_event_v1_types, 45);
