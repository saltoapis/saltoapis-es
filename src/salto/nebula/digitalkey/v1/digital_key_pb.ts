...
import type { AppKeyLocalOperation } from "@saltoapis/nebula-type";
import { file_salto_nebula_type_local_operation } from "@saltoapis/nebula-type";
...
export const file_salto_nebula_digitalkey_v1_digital_key: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_salto_longrunning_v1_operation, file_salto_nebula_type_local_operation, file_salto_nebula_type_remote_operation, file_salto_nebula_type_technology, file_salto_type_color]);
...
export type DigitalKeyAccessPoint = Message<"salto.nebula.digitalkey.v1.DigitalKeyAccessPoint"> & {
   ...
   *
   * @generated from field: repeated salto.nebula.type.AppKeyRemoteOperation remote_operations = 5;
   */
 ...
 */
export type LockDigitalKeyAccessPointRequest = Message<"salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointRequest"> & {
  /**
...
/**
 * Describes the message salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointRequest.
 * Use `create(LockDigitalKeyAccessPointRequestSchema)` to create a new message.
 */
export const LockDigitalKeyAccessPointRequestSchema: GenMessage<LockDigitalKeyAccessPointRequest> = /*@__PURE__*/
  messageDesc(file_salto_nebula_digitalkey_v1_digital_key, 14);
 ...
 */
export type LockDigitalKeyAccessPointResponse = Message<"salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointResponse"> & {
};

/**
 * Describes the message salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointResponse.
 * Use `create(LockDigitalKeyAccessPointResponseSchema)` to create a new message.
 */
export const LockDigitalKeyAccessPointResponseSchema: GenMessage<LockDigitalKeyAccessPointResponse> = /*@__PURE__*/
  messageDesc(file_salto_nebula_digitalkey_v1_digital_key, 15);
 ...
 */
export type LockDigitalKeyAccessPointMetadata = Message<"salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointMetadata"> & {
};

/**
 * Describes the message salto.nebula.digitalkey.v1.LockDigitalKeyAccessPointMetadata.
 * Use `create(LockDigitalKeyAccessPointMetadataSchema)` to create a new message.
 */
export const LockDigitalKeyAccessPointMetadataSchema: GenMessage<LockDigitalKeyAccessPointMetadata> = /*@__PURE__*/
  messageDesc(file_salto_nebula_digitalkey_v1_digital_key, 16);
...
export const DigitalKeyService: GenService<{
  ...
  lockDigitalKeyAccessPoint: {
    methodKind: "unary";
    input: typeof LockDigitalKeyAccessPointRequestSchema;
    output: typeof OperationSchema;
  },
}> = /*@__PURE__*/
