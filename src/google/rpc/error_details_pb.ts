...
export const file_google_rpc_error_details: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_duration]);
 ...
 */
export type ErrorInfo_MetadataEntry = Message<"google.rpc.ErrorInfo.MetadataEntry"> & {
  /**
...
/**
 * Describes the message google.rpc.ErrorInfo.MetadataEntry.
 * Use `create(ErrorInfo_MetadataEntrySchema)` to create a new message.
 */
export const ErrorInfo_MetadataEntrySchema: GenMessage<ErrorInfo_MetadataEntry> = /*@__PURE__*/
